...
# Теперь эти параметры берутся из .env
# OPENAI_API_KEY = "sk-..."  # Заполнить ключом API OpenAI
# OPENAI_ASSISTANT_ID = "asst_..."  # ID ассистента OpenAI для генерации объяснений
OPENAI_MODEL = "gpt-4.1-Nano"  # Модель по умолчанию, если не указана в .env
